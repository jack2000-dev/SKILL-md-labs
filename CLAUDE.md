...
This repo is a personal laboratory for authoring, testing, and storing Claude Code skills (SKILL.md files).
...
4. Install locally: copy SKILL.md to `~/.claude/skills/<name>/SKILL.md`
5. Commit

## Notes

- Skills in this repo are drafts. Installed skills live in `~/.claude/`.
- Evals are manual test cases, not automated. Run by pasting prompts into Claude.
